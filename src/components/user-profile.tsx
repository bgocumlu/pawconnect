        ...
        <div className="max-w-4xl mx-auto">
            <div className="relative mb-8">
                ...
                <div className="absolute bottom-4 right-4">
                    <Button
                        variant="outline"
                        className="bg-background/80 backdrop-blur-xs rounded-full shadow-xs"
                    >
            ...
            <div className="mt-16 px-4">
                <div className="mb-6">
                    ...
                    <div className="flex flex-wrap gap-2 mt-4">
                        <Button
                            variant="outline"
                            className="gap-1 rounded-full h-10 px-4 shadow-xs hover:shadow-sm"
                        >
                            <MessageSquare className="h-4 w-4 mr-1" />
                            Message
                        </Button>
                        <Button className="rounded-full h-10 px-4 shadow-xs hover:shadow-sm">
                            Follow
                        </Button>
                    </div>
                ...
                <div className="mt-8">
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <Button
                            variant="outline"
                            size="sm"
                            className="rounded-full h-9 px-4 gap-1 shadow-xs hover:shadow-sm"
                        >
                                ...
                                <CardFooter className="border-t pt-3">
                                    <div className="flex justify-between w-full">
                                        <Button
                                            variant="ghost"
                                            size="sm"
                                            className="gap-1 rounded-full h-9 px-3"
                                        >
