...
import { Heart, Upload, Calendar, MapPin, Mail, PawPrintIcon as Paw } from "lucide-react"
              ...
              <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={filters.age} onValueChange={(value) => handleFilterChange("age", value)}>
                    <SelectTrigger id="age" className="rounded-full">
              ...
              <form className="space-y-4">
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select>
                      <SelectTrigger id="pet-species" className="rounded-full">
                ...
                <div className="grid gap-4 sm:grid-cols-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select>
                      <SelectTrigger id="pet-gender" className="rounded-full">
