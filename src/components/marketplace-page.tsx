    ...
    <div className="bg-paw-pattern">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground mb-4">
          Buy and sell pet supplies, accessories, and more. Connect with other pet owners in your area.
        </p>
      </div>

      <Tabs defaultValue="browse" className="mb-8">
        <TabsList className="grid w-full grid-cols-2 rounded-full">
          <TabsTrigger value="browse" onClick={() => setActiveTab("browse")} className="rounded-full">
            Browse Items
          </TabsTrigger>
          <TabsTrigger value="sell" onClick={() => setActiveTab("sell")} className="rounded-full">
            Sell Item
          </TabsTrigger>
        </TabsList>
                ...
                <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={filters.category} onValueChange={(value) => handleFilterChange("category", value)}>
                      <SelectTrigger id="category" className="rounded-full w-full">
                      ...
                      <SelectContent className="rounded-xl">
                        ...
                        <SelectItem value="grooming">Grooming Supplies</SelectItem>
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      <SelectTrigger id="price" className="rounded-full w-full">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={filters.condition} onValueChange={(value) => handleFilterChange("condition", value)}>
                      <SelectTrigger id="condition" className="rounded-full w-full">
                ...
                >
                  <div className="relative h-48 overflow-hidden">
                    ...
                    <div className="absolute top-2 right-2">
                      <Badge variant={item.condition === "new" ? "default" : "secondary"} className="rounded-full px-3">
                        {item.condition}
                      </Badge>
                    </div>
                    <Button
                    ...
                    {/* Add a price tag that stands out */}
                    <div className="absolute bottom-2 right-2">
                      <Badge variant="default" className="rounded-full px-3 py-1 text-sm font-bold shadow-md">
                  ...
                  <CardFooter className="flex justify-between">
                    <Button variant="outline" size="sm" className="rounded-full h-9 px-3 shadow-xs hover:shadow-sm">
                      Message Seller
                    </Button>
                    <Button size="sm" className="rounded-full h-9 px-3 shadow-xs hover:shadow-sm">
                      View Details
                    </Button>
                  </CardFooter>
                </Card>
        ...
        <TabsContent value="sell" className="mt-6">
          <Card className="rounded-2xl border-2 shadow-xs hover:shadow-md transition-shadow duration-300">
            ...
            <CardContent>
              <form className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input id="item-title" placeholder="Enter a descriptive title" className="rounded-full" />
                </div>
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select>
                      <SelectTrigger id="item-category" className="rounded-full w-full">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <Select>
                      <SelectTrigger id="item-condition" className="rounded-full w-full">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="item-location" placeholder="City, State" className="rounded-full" />
                  </div>
                </div>
            ...
            <CardFooter>
              <Button className="w-full rounded-full h-10 shadow-xs hover:shadow-sm">List Item for Sale</Button>
            </CardFooter>
          </Card>
        </TabsContent>
      </Tabs>
