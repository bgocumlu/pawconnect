                      ...
                      <div className="grid gap-3 sm:grid-cols-2 md:grid-cols-4">
                          ...
                          <div className="space-y-1">
                              ...
                              <Select
                                  ...
                                  onValueChange={(value) =>
                                      handleFilterChange("petType", value)
                                  }
                              >
                                  <SelectTrigger
                                      id="petType"
                          ...
                          <div className="space-y-1">
                              ...
                              <Select
                                  ...
                                  onValueChange={(value) =>
                                      handleFilterChange("walkTime", value)
                                  }
                              >
                                  <SelectTrigger
                                      id="walkTime"
          ...
          {filteredBuddies.length === 0 && (
              <div className="text-center py-12">
                  <p className="text-muted-foreground">
                      No walk buddies found with these filters.
                  </p>
                  <Button
                      variant="outline"
                      className="mt-4 rounded-full shadow-xs hover:shadow-sm"
                      onClick={resetFilters}
                  >
                      Reset Filters
                  </Button>
