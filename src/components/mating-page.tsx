      ...
      <div className="bg-paw-pattern">
          <div className="mb-8">
              ...
              <p className="text-muted-foreground mb-4">
                  Browse potential mates for your pet. Connect with other pet
                  owners and arrange meetings.
              </p>
          </div>
          ...
          <Tabs defaultValue="find" className="mb-8">
              ...
              <TabsContent value="find" className="mt-3">
                  <Card className="rounded-2xl border-2 shadow-xs hover:shadow-md transition-shadow duration-300 mb-3">
                          ...
                          <form className="space-y-4">
                              <div className="space-y-2">
                                  ...
                                  <Select>
                                      ...
                                      <SelectContent className="rounded-xl">
                                          <SelectItem value="pet1">
                                              Max (Golden Retriever)
                                          </SelectItem>
                                          <SelectItem value="pet2">
                                              Luna (Siamese Cat)
                                          </SelectItem>
                                      </SelectContent>
                                  </Select>
                              ...
                              <div className="space-y-2">
                                  ...
                                  <div className="border-2 border-dashed rounded-xl p-6 text-center">
                                      ...
                                      <p className="text-xs text-muted-foreground mt-2">
                                          Upload vaccination records, health
                                          certificates, and pedigree documents.
                                      </p>
                                  </div>
                              </div>
              ...
              <TabsContent value="requests" className="mt-6">
                  <div className="text-center py-12">
                      <p className="text-muted-foreground">
                          You have no mating requests at this time.
                      </p>
                      <p className="text-sm text-muted-foreground mt-2">
                          When someone is interested in your pet, their request
                          will appear here.
                      </p>
                  </div>
              </TabsContent>
